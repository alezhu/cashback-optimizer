...
2. **Комиссии**:
   * Базовая ставка комиссии на уровне группы (`commission: %`), мин/макс комиссии (`minCommission`, `maxCommission`) и флаг округления комиссии до целого (`roundCommission`).
   * Индивидуальное переопределение всех параметров комиссии для конкретного платежа (`commissionOverride`, `roundCommissionOverride`, `minCommissionOverride`, `maxCommissionOverride`).
